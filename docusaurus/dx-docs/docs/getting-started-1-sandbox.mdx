...
<Box color="#25c2a0">
    <div className="text--center">
        <img alt="Navigation" src={useBaseUrl('_getting-started-media/1_basecamp.png')} style={{height: '150px'}}/>
    </div>
    <div className="text--center">
...
<Box color="#25c2a0">
    <div className="text--center">
        <img alt="Sign in" src={useBaseUrl('_getting-started-media/2_sandbox.png')} style={{height: '150px'}}/>
    </div>
    <div className="text--center">
...
<Box color="#25c2a0">
    <div className="text--center">
        <img alt="Sign in" src={useBaseUrl('_getting-started-media/3_data_modeler.png')} style={{height: '150px'}}/>
    </div>
    <div className="text--center">
...
<Box color="#25c2a0">
    <div className="text--center">
        <img alt="Sign in" src={useBaseUrl('_getting-started-media/4_component_builder.png')} style={{height: '150px'}}/>
    </div>
    <div className="text--center">
...
<Box color="#25c2a0">
    <div className="text--center">
        <img alt="Sign in" src={useBaseUrl('_getting-started-media/5_local_environment.png')} style={{height: '150px'}}/>
    </div>
    <div className="text--center">
...
<Box color="#25c2a0">
    <div className="text--center">
        <img alt="Sign in" src={useBaseUrl('_getting-started-media/6_server.png')} style={{height: '150px'}}/>
    </div>
    <div className="text--center">
...
<Tabs
    ...
    <TabItem value="1">
        <div style={{margin: 'auto'}}>
            ...
            <img alt="Upload" src={useBaseUrl('_getting-started-media/sandbox-step1.png')} />
        </div>
    </TabItem>
    <TabItem value="2">
        <div  style={{margin: 'auto'}}>
            ...
            <img alt="Edit" src={useBaseUrl('_getting-started-media/sandbox-step2.png')} />
        </div>
    </TabItem>
    <TabItem value="3">
        <div  style={{margin: 'auto'}}>
            ...
            <img alt="Information" src={useBaseUrl('_getting-started-media/sandbox-step3.png')}/>
        </div>
    </TabItem>
</Tabs>
...
<div className="text--center">
    <img alt="Sandbox Step 4" src={useBaseUrl('_getting-started-media/sandbox-step4.png')}/>
</div>
