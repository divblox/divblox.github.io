...
<Box color="#3578e5">
    ...
    <div className="text--center">
        4. Create a variety of divblox components and pages using the component builder
    </div>
</Box>
<Box color="#3578e5">
    <div className="text--center">
...
To download your sandbox, all you need is a [local installation of Divblox](getting-started-3-from-scratch#download-divblox) with your [project's API key](the-basics-divblox-api-key) configured.
