...
where Divblox generates ORM related functionality (located at `/divblox/config/database/data_model_orm/EntityNameGen.class.php`). It is a good idea to look through
...
<div className="text--center">
    <img data-action="zoom"  alt="Function 6 diagram" src={useBaseUrl('_divblox-best-practices-media/example-bottom-nav2.png')} />
</div>
