...
<div className="text--center">
    <img alt="UML diagram" src={useBaseUrl('_basic-training-media/training-exercise1.png')} />
</div>
...
<div className="text--center">
    <img alt="Singular relationship" src={useBaseUrl('_basic-training-media/bte-3-1.png')} />
</div>
...
<div className="text--center">
    <img alt="Navigation Menu" src={useBaseUrl('_basic-training-media/navigation-menu.png')} />
</div>

There are a few default menus, and we will create a basic-training-exercise-menu with the necessary items.

<div className="text--center">
    <img alt="Navigation Menu Modal" src={useBaseUrl('_basic-training-media/navigation-menu-modal.png')} />
</div>
...
<div className="text--center">
    <img alt="Navigation Menu HTML" src={useBaseUrl('_basic-training-media/navigation-menu-html.png')} />
</div>
...
<div className="text--center">
    <img alt="Flowchart of frontend/backend communication" src={useBaseUrl('_basic-training-media/basic-training-exercise-step5.png')} />
</div>
...
<div className="text--center">
    <img alt="UserRoleHierarchy" src={useBaseUrl('_basic-training-media/userrole-hierarchy.jpg')} />
</div>

The Component default settings are as follows:

<div className="text--center">
    <img alt="Component Access" src={useBaseUrl('_basic-training-media/basic-training-exercise-component-access.png')} />
</div>
...
<div className="text--center">
    <img alt="Data Model Access" src={useBaseUrl('_basic-training-media/basic-training-exercise-data-model-access.png')} />
</div>
...
<div className="text--center">
    <img alt="Data model role based access 1" src={useBaseUrl('_basic-training-media/bte-step-7-class-wide-loadandcount.png')} />
</div>
...
<div className="text--center">
    <img alt="Data model role based access 1" src={useBaseUrl('_basic-training-media/bte-step-7-index-based-load-methods.png')} />
</div>
...
<div className="text--center">
    <img alt="Data model role based access 1" src={useBaseUrl('_basic-training-media/bte-step-7-subtask-related.png')} />
</div>

<div className="text--center">
    <img alt="Data model role based access 1" src={useBaseUrl('_basic-training-media/bte-step-7-note-related.png')} />
</div>
...
<div className="text--center">
    <img alt="Data model role based access 1" src={useBaseUrl('_basic-training-media/bte-step-7-data-model-role-based-access-location.png')} />
</div>

We add full permission for the `Ticket` and `Category` entities.

<div className="text--center">
    <img alt="Data model role based access 1" src={useBaseUrl('_basic-training-media/bte-step-7-data-model-role-based-access-code.png')} />
</div>
...
<div className="text--center">
    <img alt="Function 6 diagram" src={useBaseUrl('_divblox-best-practices-media/example-bottom-nav2.png')} />
</div>
...
<div className="text--center">
    <img alt="bte-8-8TimeComparison" src={useBaseUrl('_basic-training-media/bte-8-8-time_comparison.png')} />
</div>
