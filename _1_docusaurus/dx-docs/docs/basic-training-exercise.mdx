...
If you need a refresh on Divblox data modelling, click [here](the-basics-data-modeler). Below is a walk-through of how to add the necessary entities using Divblox's Data Modeller.
...
It may be interesting to note how Divblox create these components in the IDE. below is a screenshot of the component file structure
...
We can do this through the Divblox Component Builder or in the source code.
