...
<div className="text--center">
    <img data-action="zoom"  alt="Environments Screenshot" src={useBaseUrl('_the-basics-media/_1-config-media/dx-setup.png')} />
</div>
...
<div className="text--center">
    <img data-action="zoom"  alt="dx-setup-environment" src={useBaseUrl('_the-basics-media/_1-config-media/dx-setup-environment.png')} />
</div>
...
<div className="text--center">
    <img data-action="zoom"  alt="Environments Screenshot" src={useBaseUrl('_the-basics-media/_1-config-media/dx-setup-api-key.png')} />
</div>
...
<div className="text--center">
    <img data-action="zoom"  alt="Environments Screenshot" src={useBaseUrl('_the-basics-media/_1-config-media/dx-setup-admin-password.png')} />
</div>
...
<div className="text--center">
    <img data-action="zoom"  alt="Environments Screenshot" src={useBaseUrl('_the-basics-media/_1-config-media/dx-setup-ui-config.png')} />
</div>
...
<div className="text--center">
    <img data-action="zoom"  alt="Environments Screenshot" src={useBaseUrl('_the-basics-media/_1-config-media/dx-setup-js-config.png')} />
</div>
...
<div className="text--center">
    <img data-action="zoom"  alt="Environments Screenshot" src={useBaseUrl('_the-basics-media/_1-config-media/dx-setup-global-functions.png')} />
</div>
...
<div className="text--center">
    <img data-action="zoom"  alt="Environments Screenshot" src={useBaseUrl('_the-basics-media/_1-config-media/medialibrary1.png')}/>
</div>
...
<Tabs
    ...
    <TabItem value="upload">
        <div style={{margin: 'auto'}}>
            <img data-action="zoom"  alt="Upload" src={useBaseUrl('_the-basics-media/_1-config-media/medialibrary1.png')} />
        </div>
    </TabItem>
    <TabItem value="edit">
        <div  style={{margin: 'auto'}}>
            ...
            <img data-action="zoom"  alt="Edit" src={useBaseUrl('_the-basics-media/_1-config-media/medialibrary2.png')} />
        </div>
    </TabItem>
    <TabItem value="info">
        <div  style={{margin: 'auto'}}>
            ...
            <img data-action="zoom"  alt="Information" src={useBaseUrl('_the-basics-media/_1-config-media/medialibrary3.png')}/>
        </div>
    </TabItem>
</Tabs>
...
<div className="text--center">
    <img data-action="zoom"  alt="Navigation" src={useBaseUrl('_the-basics-media/_1-config-media/dx-setup-navigation.png')}/>
</div>
