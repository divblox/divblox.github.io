...
<div className="text--center">
    <img alt="Environments Screenshot" src={useBaseUrl('_the-basics-media/_1-config-media/dx-setup.png')} />
</div>
...
<div className="text--center">
    <img alt="dx-setup-environment" src={useBaseUrl('_the-basics-media/_1-config-media/dx-setup-environment.png')} />
</div>
...
<div className="text--center">
    <img alt="Environments Screenshot" src={useBaseUrl('_the-basics-media/_1-config-media/setup-configure-environments.png')} />
</div>

<div className="text--center">
    <img align="center" alt="Environments Screenshot" src={useBaseUrl('_the-basics-media/_1-config-media/setup-configure-database.png')} />
</div>
...
<div className="text--center">
    <img alt="Environments Screenshot" src={useBaseUrl('_the-basics-media/_1-config-media/dx-setup-api-key.png')} />
</div>
...
<div className="text--center">
    <img alt="Environments Screenshot" src={useBaseUrl('_the-basics-media/_1-config-media/dx-setup-admin-password.png')} />
</div>
...
<div className="text--center">
    <img alt="Environments Screenshot" src={useBaseUrl('_the-basics-media/_1-config-media/dx-setup-ui-config.png')} />
</div>
...
<div className="text--center">
    <img alt="Environments Screenshot" src={useBaseUrl('_the-basics-media/_1-config-media/dx-setup-js-config.png')} />
</div>
...
<div className="text--center">
    <img alt="Environments Screenshot" src={useBaseUrl('_the-basics-media/_1-config-media/dx-setup-global-functions.png')} />
</div>
...
<div className="text--center">
    <img alt="Environments Screenshot" src={useBaseUrl('_the-basics-media/_1-config-media/medialibrary1.png')}/>
</div>
...
<Tabs
    ...
    <TabItem value="upload">
        <div style={{margin: 'auto'}}>
            <img alt="Upload" src={useBaseUrl('_the-basics-media/_1-config-media/medialibrary1.png')} />
        </div>
    </TabItem>
    <TabItem value="edit">
        <div  style={{margin: 'auto'}}>
            ...
            <img alt="Edit" src={useBaseUrl('_the-basics-media/_1-config-media/medialibrary2.png')} />
        </div>
    </TabItem>
    <TabItem value="info">
        <div  style={{margin: 'auto'}}>
            ...
            <img alt="Information" src={useBaseUrl('_the-basics-media/_1-config-media/medialibrary3.png')}/>
        </div>
    </TabItem>
</Tabs>
...
<div className="text--center">
    <img alt="Navigation" src={useBaseUrl('_the-basics-media/_1-config-media/dx-setup-navigation.png')}/>
</div>

You can create the menus here, defining how many navigation items you have and what text and/or icons are displayed.

<div className="text--center">
    <img alt="Menu Modal" src={useBaseUrl('_the-basics-media/_1-config-media/menu-modal.png')}/>
</div>
...
<div className="text--center">
    <img alt="Navbar JS Edit" src={useBaseUrl('_the-basics-media/_1-config-media/navbar-js-menu-edit.png')}/>
</div>
...
<div className="text--center">
    <img alt="Update" src={useBaseUrl('_the-basics-media/_1-config-media/update1.png')}/>
</div>
...
<div className="text--center">
    <img alt="Update2" src={useBaseUrl('_the-basics-media/_1-config-media/update2.png')}/>
</div>
