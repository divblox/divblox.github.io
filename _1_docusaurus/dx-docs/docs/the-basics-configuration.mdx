...
divblox public repo. It is also assumed that you have created a Divblox basecamp account and have at least one project.

When navigating to your project root, usually at `localhost/[project_name]` you will be greeted by a login page.
These as the steps followed to initially configure your local project.
<Tabs
    defaultValue="1"
    values={[
    ...
    <TabItem value="1">
        <div style={{margin: 'auto'}}>
            <ul>
                <li> Log in using your basecamp details</li>
            </ul>
    ...
    <TabItem value="2">
        <div  style={{margin: 'auto'}}>
            <ul>
                ...
                <li> Follow the link to create a new project on Basecamp</li>
            </ul>
    ...
    <TabItem value="3">
        <div  style={{margin: 'auto'}}>
            <ul>
                <li>Link an available environment to your local setup</li>
        ...
        <TabItem value="4">
            <div  style={{margin: 'auto'}}>
                <ul>
                    <li>Set up your database connection details</li>
                </ul>
...
Once you complete these steps successfully you will be logged into the Divblox setup page.
We will take you through the interface of Divblox's setup and what each part entails. Below is a screenshot of what you should expect upon loading
into the Divblox environment. We will first discuss the sections which have more to do with configuration of your Divblox application.
