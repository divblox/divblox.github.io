...
<div className="text--center">
    <img alt="ATE-data-model" src={useBaseUrl('_advanced-training-exercise-media/ate-data-model.png')} />
</div>
...
<div className="text--center">
    <img alt="Category_Entity" src={useBaseUrl('_advanced-training-exercise-media/new-category.png')} />
</div>
...
<div className="text--center">
    <img alt="category update page" src={useBaseUrl('_advanced-training-exercise-media/category_update_page.png')} />
</div>
...
<div className="text--center">
    <img alt="admin category click" src={useBaseUrl('_advanced-training-exercise-media/admin_category_select.png')} />
</div>
...
<div className="text--center">
    <img alt="subcategory highlighted" src={useBaseUrl('_advanced-training-exercise-media/subcategory_highlight.png')} />
</div>
...
<div className="text--center">
    <img alt="subcategory modal" src={useBaseUrl('_advanced-training-exercise-media/subcategory_modal.png')} />
</div>
...
<div className="text--center">
    <img alt="subcategory comp builder" src={useBaseUrl('_advanced-training-exercise-media/subcategory_list_compbuilder.png')} />
</div>
...
<div className="text--center">
    <img alt="subtask update layout" src={useBaseUrl('_advanced-training-exercise-media/subtask_update_arrangement.png')} />
</div>
...
<div className="text--center">
    <img alt="modal footer removal" src={useBaseUrl('_advanced-training-exercise-media/modal-footer-removal.png')} />
</div>
...
<div className="text--center">
    <img alt="dashboard screenshot" src={useBaseUrl('_advanced-training-exercise-media/dashboard-screenshot.png')} />
</div>
...
<div className="text--center">
    <img alt="subcomponent" src={useBaseUrl('_advanced-training-exercise-media/subcomponent-par-input.png')} />
</div>
...
<div className="text--center">
    <img alt="adding account summary" src={useBaseUrl('_advanced-training-exercise-media/added-account-summary.png')} />
</div>
...
<div className="text--center">
    <img alt="overdue tickets" src={useBaseUrl('_advanced-training-exercise-media/overdue_tickets.png')} />
</div>
...
<div className="text--center">
    <img alt="ticket status graph" src={useBaseUrl('_advanced-training-exercise-media/ticket_status_graph.png')} />
</div>
...
<div className="text--center">
    <img alt="category pie chart" src={useBaseUrl('_advanced-training-exercise-media/category_pie_chart.png')} />
</div>
