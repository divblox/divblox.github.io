...
which we will tailor to our needs, based off of the default 'native_file_uploader' component.
This is done via the component builder, simply by creating a new component from the existing component "default_file_uploader".
