...
<Box color="#3578e5">
    ...
    <div className="text--center">
        4. Create a new project and click "Open in Sandbox"
    </div>
</Box>
<Box color="#3578e5">
    <div className="text--center">
...
<Tabs
    ...
    <TabItem value="1">
        <div style={{margin: 'auto'}}>
            ...
            <img data-action="zoom"  alt="Upload" src={useBaseUrl('_getting-started-media/sandbox-step1.png')} />
        </div>
    </TabItem>
    <TabItem value="2">
        <div  style={{margin: 'auto'}}>
            ...
            <img data-action="zoom"  alt="Edit" src={useBaseUrl('_getting-started-media/sandbox-step2.png')} />
        </div>
    </TabItem>
    <TabItem value="3">
        <div  style={{margin: 'auto'}}>
            ...
            <img data-action="zoom"  alt="Information" src={useBaseUrl('_getting-started-media/sandbox-step3.png')}/>
        </div>
    </TabItem>
</Tabs>
