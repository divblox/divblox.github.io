...
const features = [
    {
        ...
        description: (
            <>
                Whether you’re a business owner or a software creator, Divblox
    ...
    },
    {
        ...
        description: (
            <>
                Divblox is a web and mobile app development framework that
                allows anyone to, from designers and analysts, to hard-core
                developers, to collaborate and create amazing experiences in no
                time.
            </>
        ),
    },
    {
        ...
        description: (
            <>
                Divblox promotes a web-first approach which allows you to create
                all of your solutions with the same language stack. This means
                you will always create a web app first, built on languages like
                HTML, JavaScript and CSS. Your web app can then be exported as a
