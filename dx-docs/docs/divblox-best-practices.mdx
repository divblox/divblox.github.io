...
<div className="text--center">
    <img  src={useBaseUrl('_divblox-best-practices-media/example-bottom-nav2.png')} />
</div>
...
<div className="text--center">
    <img  src={useBaseUrl('_divblox-best-practices-media/example-top-nav2.png')} />
</div>
...
<div className="text--center">
    <img  src={useBaseUrl('_divblox-best-practices-media/example-top-nav3.png')} />
</div>
...
<div className="text--center">
    <img  src={useBaseUrl('_divblox-best-practices-media/example-top-nav4.png')} />
</div>
...
<div className="text--center">
    <img  src={useBaseUrl('_divblox-best-practices-media/example-top-nav5.png')} />
</div>
...
<div className="text--center">
    <img  src={useBaseUrl('_divblox-best-practices-media/example-top-nav6.png')} />
</div>
...
<div className="text--center">
    <img src={useBaseUrl('_divblox-best-practices-media/example-instance-nav2.png')} />
</div>
...
<div className="text--center">
    <img src={useBaseUrl('_divblox-best-practices-media/example-instance-nav3.png')} />
</div>
