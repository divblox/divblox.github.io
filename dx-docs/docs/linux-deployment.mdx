...
<Tabs
    ...
    <TabItem value="usb">
        <div className="text--center">
            <img alt="RufusBefore" src={useBaseUrl('_deployment-media/rufus_before.png')} />
        </div>
    </TabItem>
    <TabItem value="usb-iso">
        <div className="text--center">
            <img alt="RufusAfter" src={useBaseUrl('_deployment-media/rufus_after.png')} />
        </div>
    </TabItem>
    <TabItem value="complete">
        <div className="text--center">
            <img alt="RufusComplete" src={useBaseUrl('_deployment-media/rufus_complete.png')} />
        </div>
    </TabItem>
</Tabs>
...
<Tabs
    ...
    values={[
        ...
        {label: 'Installation options', value: 'ubuntu3'},
        {label: 'Installation Type', value: 'ubuntu4'},
    ...
    <TabItem value="ubuntu1">
        ...
        <div className="text--center">
            <img alt="Ubuntu1" src={useBaseUrl('_deployment-media/ubuntu1.png')} />
        </div>
    </TabItem>
    <TabItem value="ubuntu2">
        ...
        <div className="text--center">
            <img alt="Ubuntu2" src={useBaseUrl('_deployment-media/ubuntu1.png')} />
        </div>
    </TabItem>
    <TabItem value="ubuntu3">
        ...
        <div className="text--center">
            <img alt="Ubuntu3" src={useBaseUrl('_deployment-media/ubuntu1.png')} />
        </div>
    </TabItem>
    <TabItem value="ubuntu4">
        ...
        <div className="text--center">
            <img alt="Ubuntu4" src={useBaseUrl('_deployment-media/ubuntu1.png')} />
        </div>
    </TabItem>
    <TabItem value="ubuntu5">
        ...
        <div className="text--center">
            <img alt="Ubuntu5" src={useBaseUrl('_deployment-media/ubuntu1.png')} />
        </div>
    </TabItem>
    <TabItem value="ubuntu6">
        ...
        <div className="text--center">
            <img alt="Ubuntu6" src={useBaseUrl('_deployment-media/ubuntu6.png')} />
        </div>
    </TabItem>
    <TabItem value="ubuntu7">
        ...
        <div className="text--center">
            <img alt="Ubuntu7" src={useBaseUrl('_deployment-media/ubuntu7.png')} />
        </div>
    </TabItem>
    <TabItem value="ubuntu8">
        ...
        <div className="text--center">
            <img alt="Ubuntu8" src={useBaseUrl('_deployment-media/ubuntu8.png')} />
        </div>
    </TabItem>
    <TabItem value="ubuntu9">
        ...
        <div className="text--center">
            <img alt="Ubuntu9" src={useBaseUrl('_deployment-media/ubuntu9.png')} />
        </div>
    </TabItem>
</Tabs>
...
<Tabs
    ...
    <TabItem value="in1">
        <div className="text--center">
            ...
            <img alt="in1" src={useBaseUrl('_deployment-media/in1.png')} />
        </div>
    </TabItem>
    <TabItem value="in2">
        <div className="text--center">
            ...
            <img alt="in2" src={useBaseUrl('_deployment-media/in2.png')} />
        </div>
    </TabItem>
    <TabItem value="in3">
        <div className="text--center">
            ...
            <img alt="in3" src={useBaseUrl('_deployment-media/in3.png')} />
        </div>
    </TabItem>
    <TabItem value="in4">
        <div className="text--center">
            ...
            <img alt="in4" src={useBaseUrl('_deployment-media/in4.png')} />
        </div>
    </TabItem>
    <TabItem value="in5">
        <div className="text--center">
            ...
            <img alt="in5" src={useBaseUrl('_deployment-media/in5.png')} />
        </div>
    </TabItem>
</Tabs>
...
<div className="text--center">
    <img alt="Installs 1" src={useBaseUrl('_deployment-media/installs1.png')} />
</div>
...
<div className="text--center">
    <img alt="Installs 2" src={useBaseUrl('_deployment-media/installs2.png')} />
</div>
...
<div className="text--center">
    <img alt="Installs 3" src={useBaseUrl('_deployment-media/installs3.png')} />
</div>
...
<div className="text--center">
    <img alt="Installs 4" src={useBaseUrl('_deployment-media/installs4.png')} />
</div>
...
<div className="text--center">
    <img alt="Installs 5" src={useBaseUrl('_deployment-media/installs5.png')} />
</div>
...
<div className="text--center">
    <img alt="MySQL 1" src={useBaseUrl('_deployment-media/mysql1.png')} />
</div>
...
<Tabs
    ...
    <TabItem value="myphpadmin1">
        <div className="text--center">
            ...
            <img alt="myphpadmin1" src={useBaseUrl('_deployment-media/phpmyadmin1.png')} />
        </div>
    </TabItem>
    <TabItem value="myphpadmin2">
        <div className="text--center">
            ...
            <img alt="myphpadmin2" src={useBaseUrl('_deployment-media/phpmyadmin2.png')} />
        </div>
    </TabItem>
</Tabs>
...
<Tabs
    ...
    <TabItem value="ioncube1">
        <div className="text--center">
            ...
            <img alt="ioncube1" src={useBaseUrl('_deployment-media/ion_cube_initial.png')} />
        </div>
    </TabItem>
    <TabItem value="ioncube2">
        <div className="text--center">
            ...
            <img alt="ioncube2" src={useBaseUrl('_deployment-media/ion_cube_final.png')} />
        </div>
    </TabItem>
</Tabs>
