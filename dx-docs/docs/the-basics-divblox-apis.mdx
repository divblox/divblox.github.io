...
<div className="text--center">
    <img alt="Exposing an API 1" src={useBaseUrl('_the-basics-media/_5-divblox-apis-media/exposing-an-api1.png')} />
</div>
...
<div className="text--center">
    <img alt="Exposing an API 2" src={useBaseUrl('_the-basics-media/_5-divblox-apis-media/exposing-an-api2.png')} />
</div>
...
<div className="text--center">
    <img alt="Exposing an API 3" src={useBaseUrl('_the-basics-media/_5-divblox-apis-media/exposing-an-api3.png')} />
</div>
...
<div className="text--center">
    <img alt="Exposing an API 4" src={useBaseUrl('_the-basics-media/_5-divblox-apis-media/exposing-an-api4.png')} />
</div>
...
<div className="text--center">
    <img alt="Exposing an API 5" src={useBaseUrl('_the-basics-media/_5-divblox-apis-media/exposing-an-api5.png')} />
</div>
...
<div className="text--center">
    <img alt="Securing an API 1" src={uFseBaseUrl('_the-basics-media/_5-divblox-apis-media/securing-an-api1.png')} />
</div>
...
<div className="text--center">
    <img alt="Securing an API 2" src={useBaseUrl('_the-basics-media/_5-divblox-apis-media/securing-an-api2.png')} />
</div>
...
<div className="text--center">
    <img alt="Securing an API 3" src={useBaseUrl('_the-basics-media/_5-divblox-apis-media/securing-an-api3.png')} />
</div>
...
<div className="text--center">
    <img alt="Securing an API 4" src={useBaseUrl('_the-basics-media/_5-divblox-apis-media/securing-an-api4.png')} />
</div>
...
<div className="text--center">
    <img alt="Securing an API 5" src={useBaseUrl('_the-basics-media/_5-divblox-apis-media/securing-an-api5.png')} />
</div>
...
<div className="text--center">
    <img alt="Securing an API 6" src={useBaseUrl('_the-basics-media/_5-divblox-apis-media/securing-an-api6.png')} />
</div>
...
<div className="text--center">
    <img alt="Securing an API 7" src={useBaseUrl('_the-basics-media/_5-divblox-apis-media/securing-an-api7.png')} />
</div>
...
<div className="text--center">
    <img alt="Securing an API 8" src={useBaseUrl('_the-basics-media/_5-divblox-apis-media/securing-an-api8.png')} />
</div>

9. Start adding operations to this key by clicking "+ API Operation"

<div className="text--center">
    <img alt="Securing an API 9" src={useBaseUrl('_the-basics-media/_5-divblox-apis-media/securing-an-api9.png')} />
</div>
...
<div className="text--center">
    <img alt="Securing an API 10" src={useBaseUrl('_the-basics-media/_5-divblox-apis-media/securing-an-api10.png')} />
</div>
...
<div className="text--center">
    <img alt="Securing an API 11" src={useBaseUrl('_the-basics-media/_5-divblox-apis-media/securing-an-api11.png')} />
</div>

12. Testing the API operation with the API key gives back a "Success" status message and completed the API operation.

<div className="text--center">
    <img alt="Securing an API 12" src={useBaseUrl('_the-basics-media/_5-divblox-apis-media/securing-an-api12.png')} />
</div>
...
<div className="text--center">
    <img alt="API Default CRUD 1" src={useBaseUrl('_the-basics-media/_5-divblox-apis-media/api-default-crud1.png')} />
</div>
...
<div className="text--center">
    <img alt="API Default CRUD 2" src={useBaseUrl('_the-basics-media/_5-divblox-apis-media/api-default-crud2.png')} />
</div>
...
<div className="text--center">
    <img alt="API Default CRUD 3" src={useBaseUrl('_the-basics-media/_5-divblox-apis-media/api-default-crud3.png')} />
</div>
...
<div className="text--center">
    <img alt="API Default CRUD 4" src={useBaseUrl('_the-basics-media/_5-divblox-apis-media/api-default-crud4.png')} />
</div>

5.  Sync your data model. Ensure that Divblox's data model is synced so that the CRUD operations can be used.

<div className="text--center">
    <img alt="API Default CRUD 5" src={useBaseUrl('_the-basics-media/_5-divblox-apis-media/api-default-crud5.png')} />
</div>
...
<div className="text--center">
    <img alt="API Default CRUD 6" src={useBaseUrl('_the-basics-media/_5-divblox-apis-media/api-default-crud6.png')} />
</div>
...
<div className="text--center">
    <img alt="API Default CRUD 7" src={useBaseUrl('_the-basics-media/_5-divblox-apis-media/api-default-crud7.png')} />
</div>
...
<div className="text--center">
    <img alt="API Default CRUD 8" src={useBaseUrl('_the-basics-media/_5-divblox-apis-media/api-default-crud8.png')} />
</div>