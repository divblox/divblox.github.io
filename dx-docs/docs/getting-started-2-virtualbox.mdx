...
<div className="text--center">
    <img alt="Sign in" src={useBaseUrl('_getting-started-media/virtual-machine-setup1.png')}/>
</div>
...
<div className="text--center">
    <img alt="Sign in" src={useBaseUrl('_getting-started-media/virtual-machine-setup2.png')}/>
</div>
...
<div className="text--center">
    <img alt="Sign in" src={useBaseUrl('_getting-started-media/virtual-machine-setup3.png')}/>
</div>
...
<div className="text--center">
    <img alt="Sign in" src={useBaseUrl('_getting-started-media/setup-configure-api-key.png')}/>
</div>
