...
<Box color="#25c2a0">
    ...
    <div className="text--center">
        5. <a style={{color: 'black'}} href="#option-2-starting-with-virtualbox">Initialize a local deployment environment</a> to pull down your sandbox changes and get your project ready to be published
    </div>
</Box>
<Box color="#25c2a0">
    <div className="text--center">
