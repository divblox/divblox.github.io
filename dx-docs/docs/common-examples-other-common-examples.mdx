...
<div className="text--center">
    <img alt="Example Look and Feel 1" src={useBaseUrl('_media/_screenshots/example-look-and-feel1.png')} />
</div>
...
<div className="text--center">
    <img alt="Example Look and Feel 2" src={useBaseUrl('_media/_screenshots/example-look-and-feel2.png')} />
</div>
...
<div className="text--center">
    <img alt="Example Look and Feel 3" src={useBaseUrl('_media/_screenshots/example-look-and-feel3.png')} />
</div>
...
<div className="text--center">
    <img alt="Example Look and Feel 3" src={useBaseUrl('_media/_screenshots/example-look-and-feel4.png')} />
</div>
...
<div className="text--center">
    <img alt="Example Add new Font 1" src={useBaseUrl('_media/_screenshots/example-add-new-font1.png')} />
</div>
...
<div className="text--center">
    <img alt="Example Add new Font 2" src={useBaseUrl('_media/_screenshots/example-add-new-font2.png')} />
</div>
...
<div className="text--center">
    <img alt="Example Add new Font 3" src={useBaseUrl('_media/_screenshots/example-add-new-font3.png')} />
</div>
...
<div className="text--center">
    <img alt="Example Add new Font 4" src={useBaseUrl('_media/_screenshots/example-add-new-font4.png')} />
</div>

<div className="text--center">
    <img alt="Example Add new Font 5" src={useBaseUrl('_media/_screenshots/example-add-new-font5.png')} />
</div>
...
<div className="text--center">
    <img alt="Example Add new Font 6" src={useBaseUrl('_media/_screenshots/example-add-new-font6.png')} />
</div>

<div className="text--center">
    <img alt="Example Add new Font 7" src={useBaseUrl('_media/_screenshots/example-add-new-font7.png')} />
</div>
...
<div className="text--center">
    <img alt="Example Add new Font 8" src={useBaseUrl('_media/_screenshots/example-add-new-font8.png')} />
</div>
...
<div className="text--center">
    <img alt="Example Logo 1" src={useBaseUrl('_media/_screenshots/example-change-logo1.png')} />
</div>

2. Drag and drop your logo or icon of choice into the upload areas.

<div className="text--center">
    <img alt="Example Logo 2" src={useBaseUrl('_media/_screenshots/example-change-logo2.png')} />
</div>

3. Divblox updates the logo upon adding the new image.

<div className="text--center">
    <img alt="Example Logo 3" src={useBaseUrl('_media/_screenshots/example-change-logo3.png')} />
</div>

4. Opening up a page with the logo on it will show that it has been updated.

<div className="text--center">
    <img alt="Example Logo 4" src={useBaseUrl('_media/_screenshots/example-change-logo4.png')} />
</div>
...
<div className="text--center">
    <img alt="Example Change logo 1" src={useBaseUrl('_media/_screenshots/example-change-plogo1.png')} />
</div>
...
<div className="text--center">
    <img alt="Example Change logo 2" src={useBaseUrl('_media/_screenshots/example-change-plogo2.png')} />
</div>
...
<div className="text--center">
    <img alt="Adding Logo 1" src={useBaseUrl('_media/_screenshots/example-adding-logo1.png')} />
</div>

5. Add in the line, that includes the logo from step 1, into the HTML section.

<div className="text--center">
    <img alt="Adding Logo 2" src={useBaseUrl('_media/_screenshots/example-adding-logo2.png')} />
</div>

6. Save and close to view the page. The logo should now be present in the container that was just created.

<div className="text--center">
    <img alt="Adding Logo 3" src={useBaseUrl('_media/_screenshots/example-adding-logo3.png')} />
</div>
...
<div className="text--center">
    <img alt="Adding Logo 4" src={useBaseUrl('_media/_screenshots/example-adding-logo4.png')} />
</div>
...
<div className="text--center">
    <img alt="Adding Profile Pic 1" src={useBaseUrl('_media/_screenshots/example-adding-profilePic1.png')} />
</div>

3. Create the image viewer and take note that there is no image to be viewed.

<div className="text--center">
    <img alt="Adding Profile Pic 2" src={useBaseUrl('_media/_screenshots/example-adding-profilePic2.png')} />
</div>
...
<div className="text--center">
    <img alt="Adding Profile Pic 3" src={useBaseUrl('_media/_screenshots/example-adding-profilePic3.png')} />
</div>
...
<div className="text--center">
    <img alt="Adding Profile Pic 4" src={useBaseUrl('_media/_screenshots/example-adding-profilePic4.png')} />
</div>
...
<div className="text--center">
    <img alt="Email Class Extensions" src={useBaseUrl('_email-media/email_class_extensions.png')} />
</div>
